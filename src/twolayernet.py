...
def mini_batch_study():
  ...
  # ハイパーパラメータ
  iters_num = 1000 # 試行回数
  train_size = x_train.shape[0] # 学習データの画像の枚数
  batch_size = 20 # ミニバッチを作る数
  learning_rate = 0.1 # 学習率

  # エポックの計算
  iter_per_epoch = max(iters_num / batch_size, 1)

  # ニューラルネットワークのオブジェクトの作成
